...
$('form.search-form').submit(function(){
	$.fn.yiiGridView.update('ssf-types-grid', {
		data: $(this).serialize()
	});
	return false;
});
$('#delete-button').click(function(){
    var selects = $.fn.yiiGridView.getSelection('ssf-types-grid');
    if(selects==''){
        alert('请选中记录进行操作！');
    }else{
        ...
        <div class="inbox-sf">
            <form class="search-form">
                ...
                $this->Widget('ext.searchField.searchFieldWidget', array(
                    'initText' => '',
                    'titleText' => '输入名称查询',
                    'inputName' => 'SsfTypes[name]',
                    'inputId' => 'SsfTypes_name_search',
                ));
                ?>
        ...
        $this->widget('zii.widgets.grid.CGridView', array(
            ...
            'columns' => array(
                ...
                array(
                    ...
                    'value' => 'Yii::app()->controller->getColumnOptions($data->id,"SsfTypes")',
                ),
            ),
        ));
        ?>         
