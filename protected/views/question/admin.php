...
$('#delete-button').click(function(){
    var selects = $.fn.yiiGridView.getSelection('question-grid');
    if(selects==''){
        alert('请选中记录进行操作！');
    }else{
        ...
        <div class="inbox-sf">
            <form class="search-form">
                ...
                $this->Widget('ext.searchField.searchFieldWidget', array(
                    'initText' => '',
                    'titleText' => '输入问题查询',
                    'inputName' => 'Question[question]',
                    'inputId' => 'Question_question',
                ));
                ?><input type="submit" name="" value="查询" class="inbox-sf-search-btn" />
            </form>
            <a class="button red fr tip" id="delete-button" href="javascript:void(null);" title="选中数据进行删除！">
                <span>批量删除</span>
            </a>
        ...
        $this->widget('zii.widgets.grid.CGridView', array(
            ...
            'columns' => array(
                ...
                array(
                    ...
                    'value' => 'Yii::app()->controller->getColumnOptions($data->id,"Question")',
                ),
            ),
        ));
        ?>         
