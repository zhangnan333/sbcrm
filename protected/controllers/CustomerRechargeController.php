...
class CustomerRechargeController extends Controller {
    ...
    public function actionCreate() {
        ...
        if (isset($_POST['CustomerRecharge'])) {
            $model->attributes = $_POST['CustomerRecharge'];
            if ($model->save()) {
    ...
    public function actionIndex() {
        $model = new CustomerRecharge('search');
        $model->unsetAttributes();  // clear any default values
        if (isset($_REQUEST['CustomerRecharge']))
            $model->attributes = $_REQUEST['CustomerRecharge'];
    ...
    public function loadModel($id) {
        $model = CustomerRecharge::model()->findByPk((int) $id);
        if ($model === null)
    ...
    protected function performAjaxValidation($model) {
        if (isset($_POST['ajax']) && $_POST['ajax'] === 'customer-recharge-form') {
