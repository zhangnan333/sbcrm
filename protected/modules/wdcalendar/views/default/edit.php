                ...
                <form action="<?php echo Yii::app()->controller->createUrl('/wdcalendar/default/datafeed', array('method' => 'adddetails', 'id' => isset($event) ? $event->Id : '')) ?>" class="fform" id="fmEdit" method="post"> 
                    ...
                    <label>                    
                        ...
                        <div>  
                            <?php
                            if (isset($event)) {
                                $sarr = explode(" ", Jqcalendar::model()->php2JsTime(strtotime($event->StartTime)));
                                $earr = explode(" ", Jqcalendar::model()->php2JsTime(strtotime($event->EndTime)));
                            }
                            ?>                    
                    ...
                    <label>                    
                        <span>备注:</span>                    
                        <textarea cols="20" id="Description" name="Description" rows="2" style="width:95%; height:70px"><?php echo isset($event) ? $event->Description : ""; ?></textarea>
                    </label>                
