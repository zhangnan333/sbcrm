...
; (function($) {
    ...
    $.fn.bcalendar = function(option) {
        ...
        function getTitle(event) {			
            var timeshow, locationshow, attendsshow, eventshow, descriptionshow;
            ...
            descriptionshow = (event[11] != undefined && event[11] != "") ? event[11] : "";
            var ret = [];
            if (event[4] == 1) {
            ...
            if (descriptionshow != "") {
                ret.push($.browser.mozilla ? "":"\r\n", i18n.xgcalendar.descriptionshow + ":", descriptionshow);
            }
            return ret.join("");
        }
        ...
        function dayshow(e, data) {
            ...
            if (data != null) {
                if (option.quickDeleteUrl != "" && data[8] == 1 && option.readonly != true) {
                    ...
                    $("#bbit-cs-what").html('<h3>' + data[1] + '</h3><p>' + data[11] + '</p>');
